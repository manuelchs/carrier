...
<head>
    ...
    <title>Carrier Guadalajara - Equipos - Tráiler</title>
</head>
<body>
    <?php $page = 'equipos'; ?>
    ...
    <div class="main-wrapper shop">
        <div class="general-max-width">
            <div class="title-shop">
                ...
                <div class="route custom-animation custom-animation-top"><a href="/equipos/">Productos</a><i class="fal fa-chevron-right"></i><span>Tráiler</span></div>
